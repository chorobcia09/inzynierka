<?php
/* Smarty version 5.6.0, created on 2025-11-22 14:19:01
  from 'file:feedback_panel.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_6921b845405160_90675618',
...
function content_6921b845405160_90675618 (\Smarty\Template $_smarty_tpl) {
...
<div class="table-wrapper">
    <div class="table-scroll">
        ...
        <table class="table table-dark table-striped table-bordered mb-0 align-middle">
...
?>
                    <tr>
                        ...
                        <td class="fw-semibold"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('feedback')['subject']), ENT_QUOTES, 'UTF-8');?>
</td>
...
">
                                ...
                                <select name="status" class="form-select form-select-sm bg-secondary text-light border-0">
                                    ...
                                    <option value="resolved" <?php if ($_smarty_tpl->getValue('feedback')['status'] == 'resolved') {?>selected<?php }?>>Rozwiązane
                                    </option>
                                </select>
