<?php
/* Smarty version 5.6.0, created on 2025-12-13 15:18:51
  from 'file:edit_user.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_693d75cb80dd29_96668536',
...
function content_693d75cb80dd29_96668536 (\Smarty\Template $_smarty_tpl) {
...
" required>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control bg-secondary text-light border-0"
                value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('user')['email']), ENT_QUOTES, 'UTF-8');?>
" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="account_type" class="form-select bg-secondary text-light border-0">
                <option value="standard" <?php if ($_smarty_tpl->getValue('user')['account_type'] == 'standard') {?>selected<?php }?>>Standard</option>
                <option value="premium" <?php if ($_smarty_tpl->getValue('user')['account_type'] == 'premium') {?>selected<?php }?>>Premium</option>
            </select>
        </div>
