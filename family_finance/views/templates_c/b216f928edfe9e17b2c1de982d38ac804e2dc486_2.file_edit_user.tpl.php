<?php
/* Smarty version 5.6.0, created on 2025-10-17 18:34:10
  from 'file:edit_user.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_68f27002ae94d2_05065096',
...
function content_68f27002ae94d2_05065096 (\Smarty\Template $_smarty_tpl) {
...
<form method="post" class="mt-4">
    <div class="mb-3">
        ...
        <input type="text" name="username" class="form-control" value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('user')['username']), ENT_QUOTES, 'UTF-8');?>
" required>
    </div>

    <div class="mb-3">
        <label for="email" class="form-label">Email</label>
        <input type="email" name="email" class="form-control" value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('user')['email']), ENT_QUOTES, 'UTF-8');?>
" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" name="family_id" class="form-control" value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('user')['family_id']), ENT_QUOTES, 'UTF-8');?>
">
    </div>
