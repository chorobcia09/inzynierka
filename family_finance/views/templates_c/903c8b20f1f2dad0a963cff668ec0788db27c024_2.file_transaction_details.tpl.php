<?php
/* Smarty version 5.6.0, created on 2025-11-29 10:13:08
  from 'file:transaction_details.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.6.0',
  'unifunc' => 'content_692ab92430c821_19617609',
...
function content_692ab92430c821_19617609 (\Smarty\Template $_smarty_tpl) {
...
?>
                        ...
                        <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('in_array')($_smarty_tpl->getValue('trans')['transaction_currency'],array('BTC','ETH','BNB','XRP','DOGE','SOL','ADA','TRX','USDT'))) {?>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('trans')['amount'],$_smarty_tpl->getValue('precision'),","," ")), ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('trans')['transaction_currency']), ENT_QUOTES, 'UTF-8');?>
                            ...
                            <td><?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('line_total'),$_smarty_tpl->getValue('precision'),","," ")), ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('trans')['transaction_currency']), ENT_QUOTES, 'UTF-8');?>
</td>
                        </tr>
                    <?php
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            ...
            <table class="table table-dark table-bordered mt-2 mb-0">
                <tbody class="table-secondary text-dark">
                    <tr>
                        <td><strong>Suma:</strong> <?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('number_format')($_smarty_tpl->getValue('total'),$_smarty_tpl->getValue('precision'),","," ")), ENT_QUOTES, 'UTF-8');?>
